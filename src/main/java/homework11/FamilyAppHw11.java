...
public class FamilyAppHw11 {
    static FamilyService familyService = new FamilyService(new CollectionFamilyDao(new ArrayList<>()));
...
//            familyController.displayAllFamilies();
    ...
    static void showAllFamilies() throws IOException {
        ...
        try {
            ...
            System.out.println("Sorry, the list of families is empty\n");
        }
    }
